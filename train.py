        ...
        for train_dataloader, valid_dataloader in loader_list:
            ...
            for batch_img, batch_label, folder, filename in train_bar:
                ...
                train_bar.set_description(
                    desc='[%d/%d] | Train Loss: %.4f' % (epoch + 1, EPOCH, loss.item()))
            ...
            with torch.no_grad():
                ...
                for batch_img, batch_label, _, _ in val_bar:
                    ...
                    sum_val_loss += loss
                    sum_val_correct += torch.sum(pred_classes == batch_label)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-rs", "--resize_size", type=int, default=128) # 0 to not resize
